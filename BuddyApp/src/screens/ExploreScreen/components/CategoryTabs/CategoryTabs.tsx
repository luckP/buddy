...
const CategoryTabs: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Icon name="ellipsis-h" size={20} color={selectedTab === 'All' ? '#FFD700' : '#666'} />
      ...
      >
        <Icon name="leaf" size={20} color={selectedTab === 'Grooming' ? '#FFD700' : '#666'} />
      ...
      >
        <Icon name="plus" size={20} color={selectedTab === 'Veterinary' ? '#FFD700' : '#666'} />
      ...
      >
        <Icon name="user-secret" size={20} color={selectedTab === 'Training' ? '#FFD700' : '#666'} />
